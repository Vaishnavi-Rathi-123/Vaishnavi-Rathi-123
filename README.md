...
- **Netflix Clone** — Responsive UI clone using HTML and CSS  
- **Restaurant Website** — Modern and responsive restaurant website frontend  
- **C++ DSA Practice Programs** — Implementations of core data structures and algorithms  
